...
setMethod("validate_months",
          list(form = "IOTCForm3CEMultiple", strata = "data.table"),
...
setMethod("validate_data",
          list(form = "IOTCForm3CEMultiple", metadata_validation_results = "list"),
...
setMethod("data_validation_summary",
          list(form = "IOTCForm3CEMultiple", metadata_validation_results = "list", data_validation_results = "list"),
