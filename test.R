...
write.table(summary$validation_messages,
            file = "./test/sample_forms/Form-1RC - interim_summary.csv",
            sep = ",", row.names = FALSE)
...
write.table(summary$validation_messages,
            file = "./test/sample_forms/Form-1DI - interim_summary.csv",
            sep = ",", row.names = FALSE)
...
write.table(summary$validation_messages,
            file = "./test/sample_forms/Form-3CE - interim_summary.csv",
            sep = ",", row.names = FALSE)
...
FORM_3CE_UPD =
  new("IOTCForm3CEUpdate",
      ...
      original_name = "Form-3CE-update.xlsx"
  )

summary = validation_summary(FORM_3CE_UPD)

write.table(summary$validation_messages,
            file = "./test/sample_forms/Form-3CE-update - interim_summary.csv",
            sep = ",", row.names = FALSE)
...
write.table(summary$validation_messages,
            file = "./test/sample_forms/Form-4SF - interim_summary.csv",
            sep = ",", row.names = FALSE)
...
write.table(summary$validation_messages,
            file = "./test/sample_forms/Form-4SF-update - interim_summary.csv",
            sep = ",", row.names = FALSE)
