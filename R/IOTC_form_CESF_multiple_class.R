...
setMethod("validate_data",
          list(form = "IOTCFormCESFMultiple", metadata_validation_results = "list"),
...
setMethod("common_data_validation_summary",
          list(form = "IOTCFormCESFMultiple", metadata_validation_results = "list", data_validation_results = "list"),
