...
#' @export IOTCForm3CEUpdate
IOTCForm3CEUpdate = setClass(
  "IOTCForm3CEUpdate",
  contains = "IOTCFormCESFUpdate"
)

setMethod("form_type", "IOTCForm3CEUpdate", function(form) {
  return(c("3-CE-update", "3CE-update")) # For backwards compatibility
})

setMethod("form_version", "IOTCForm3CEUpdate", function(form) {
  return("1.0.0")
})

setMethod("form_dataset_code", "IOTCForm3CEUpdate", function(form) {
  return("CE")
})

setMethod("allow_empty_data", "IOTCForm3CEUpdate", function(form) {
  return(TRUE)
})

setMethod("estimation_column", "IOTCForm3CEUpdate", function(form) {
  return("D")
})

setMethod("first_data_column", "IOTCForm3CEUpdate", function(form) {
  return(which(EXCEL_COLUMNS == "H"))
})

setMethod("first_data_row", "IOTCForm3CEUpdate", function(form) {
  return(6)
})

setMethod("first_strata_column", "IOTCForm3CEUpdate", function(form) {
  return(which(EXCEL_COLUMNS == "B"))
})

setMethod("last_strata_column", "IOTCForm3CEUpdate", function(form) {
...
setMethod("extract_metadata", list(form = "IOTCForm3CEUpdate", common_metadata = "list"), function(form, common_metadata) {
  l_info("IOTCForm3CEUpdate.extract_metadata")
...
setMethod("validate_metadata", list(form = "IOTCForm3CEUpdate", common_metadata_validation_results = "list"), function(form, common_metadata_validation_results) {
  l_info("IOTCForm3CEUpdate.validate_metadata")
...
setMethod("metadata_validation_summary", list(form = "IOTCForm3CEUpdate", metadata_validation_results = "list"), function(form, metadata_validation_results) {
  l_info("IOTCForm3CEUpdate.metadata_validation_summary")
...
setMethod("extract_data", "IOTCForm3CEUpdate", function(form) {
  l_info("IOTCForm3CEUpdate.extract_data")
...
setMethod("validate_data", list(form = "IOTCForm3CEUpdate", metadata_validation_results = "list"), function(form, metadata_validation_results) {
  l_info("IOTCForm3CEUpdate.validate_data")
...
setMethod("data_validation_summary", list(form = "IOTCForm3CEUpdate", metadata_validation_results = "list", data_validation_results = "list"), function(form, metadata_validation_results, data_validation_results) {
  l_info("IOTCForm3CEUpdate.data_validation_summary")
...
setMethod("extract_output", list(form = "IOTCForm3CEUpdate", wide = "logical"),
          function(form, wide) {
            form = read(form)
