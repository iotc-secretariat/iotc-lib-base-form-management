...
#' @export IOTCFormCESFUpdate
IOTCFormCESFUpdate = setClass(
  "IOTCFormCESFUpdate",
  contains = "IOTCForm"
)
...
setMethod("extract_metadata", list(form = "IOTCFormCESFUpdate", common_metadata = "list"), function(form, common_metadata) {
  l_info("IOTCFormCESFUpdate.extract_metadata")
...
setMethod("validate_metadata", list(form = "IOTCFormCESFUpdate", common_metadata_validation_results = "list"), function(form, common_metadata_validation_results) {
  l_info("IOTCFormCESFUpdate.validate_metadata")
...
setMethod("metadata_validation_summary", list(form = "IOTCFormCESFUpdate", metadata_validation_results = "list"), function(form, metadata_validation_results) {
  l_info("IOTCFormCESFUpdate.metadata_validation_summary")
...
setMethod("validate_data", list(form = "IOTCFormCESFUpdate", metadata_validation_results = "list"), function(form, metadata_validation_results) {
  l_info("IOTCFormCESFUpdate.validate_data")
...
setMethod("common_data_validation_summary", list(form = "IOTCFormCESFUpdate", metadata_validation_results = "list", data_validation_results = "list"), function(form, metadata_validation_results, data_validation_results) {
  l_info("IOTCFormCESFUpdate.common_data_validation_summary")
